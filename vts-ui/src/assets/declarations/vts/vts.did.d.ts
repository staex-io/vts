...
export type Result_3 = { 'Ok' : User } |
  { 'Err' : Error };
export type Result_4 = { 'Ok' : Vehicle } |
  { 'Err' : Error };
export type Result_5 = { 'Ok' : Array<[Principal, null]> } |
  { 'Err' : Error };
...
export interface _SERVICE {
  ...
  'get_vehicle' : ActorMethod<[Principal], Result_4>,
  'get_vehicles_by_agreement' : ActorMethod<[bigint], Result_5>,
